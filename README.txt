...
demo.ipynb          --   Download the files from the Data folder and upload onto your Jupiter notebook, run our code to get F1 score on test and train data. ****NOTE ALSO DISPLAYS THE SUCCESSFULLY CLASSIFIED IMAGES AND FAILURES AS WELL ***** The images have also been uploaded to the repository.
